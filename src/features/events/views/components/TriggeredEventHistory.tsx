...
export default function TriggeredEventHistory({
  history,
  loading,
  error,
  onTriggerClick,
              ...
              history.map((ev) => (
                ...
                >
                  <td className="px-4 py-3">
                    <span
                      className={`px-2 py-0.5 rounded text-xs font-semibold ${EVENT_TYPE_BADGE[ev.event_type]}`}
                    >
                      {EVENT_TYPE_LABELS[ev.event_type]}
                    </span>
                  </td>
                  <td className="px-4 py-3 text-zinc-500 text-xs">
                    {SCOPE_LABELS[ev.scope]}
                  </td>
